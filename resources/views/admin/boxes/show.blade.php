            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="form-group">
                        <label for="id" class="col-sm-2 control-label">{{ trans('column.code') }}</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="id" id="id" value="{{ $box->id or '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="price_per_night" class="col-sm-2 control-label">{{ trans('column.price_per_night') }}</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label for="scaffold_id" class="col-sm-2 control-label">{{ trans('column.scaffold') }}</label>
                        <div class="col-sm-10">
                ...
                <div class="col-md-2">
                    <div class="list-group">
                        ...
                        <a href="../box" class="list-group-item"><span class="fa fa-arrow-left"></span> {{ trans('regular.back') }}</a>
                    </div>
                </div>
            </div>
        </form>
