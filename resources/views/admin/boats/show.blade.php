        ...
        <form class="form-horizontal" action="{{ ($method == 'POST') ? '/admin/boat' : '/admin/boat/' . $boat->id }}" method="post">
            <div class="row">
                <div class="col-md-10">
                    ...
                    <div class="form-group">
                        <label for="user_id" class="col-sm-2 control-label">{{ trans('boatinfo.owner') }}</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label for="brand" class="col-sm-2 control-label">{{ trans('boatinfo.brand') }}</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="brand" id="brand" value="{{ $boat->brand or '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="type" class="col-sm-2 control-label">{{ trans('boatinfo.type') }}</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="type" id="type" value="{{ $boat->type or '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="color" class="col-sm-2 control-label">{{ trans('boatinfo.color') }}</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="color" id="color" value="{{ $boat->color or '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="height" class="col-sm-2 control-label">{{ trans('boatinfo.height') }}</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name="height" id="height" value="{{ $boat->height or '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="length" class="col-sm-2 control-label">{{ trans('boatinfo.length') }}</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name="length" id="length" value="{{ $boat->length or '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="depth" class="col-sm-2 control-label">{{ trans('boatinfo.depth') }}</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" name="depth" id="depth" value="{{ $boat->depth or '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="width" class="col-sm-2 control-label">{{ trans('boatinfo.width') }}</label>
                        <div class="col-sm-10">
                ...
                <div class="col-md-2">
                    <div class="list-group">
                        ...
                        <a href="../boat" class="list-group-item"><span class="fa fa-arrow-left"></span> {{ trans('regular.back') }}
                        </a>
                    </div>
                </div>
            </div>
